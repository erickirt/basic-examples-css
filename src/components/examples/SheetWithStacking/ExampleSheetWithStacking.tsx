              ...
              <Scroll.Content className="ExampleSheetWithStacking-scrollContent">
                ...
                <div className="ExampleSheetWithStacking-info">
                  <div className="ExampleSheetWithStacking-identification">
                    <SheetWithStackingTitle className="ExampleSheetWithStacking-username">
                      {data.name}
                    </SheetWithStackingTitle>
                ...
                <div className="ExampleSheetWithStacking-nestedSheetRoot">
                  <section className="ExampleSheetWithStacking-posts">
                    {data.content.map((post: any, index: number) => (
                      <div
                        className="ExampleSheetWithStacking-post"
                        key={index}
                      >
                        {post.reposted && (
                          <>
                  ...
                  {data.nestedSheet && (
                    <SheetWithStackingRoot>
                      <div className="ExampleSheetWithStacking-relatedPages">
                        <SheetWithStackingTrigger className="ExampleSheetWithStacking-trigger">
                          Sheet with Stacking
                        </SheetWithStackingTrigger>
                      </div>
...
const ExampleSheetWithStacking = ({ data }: any) => {
  return (
    <SheetWithStackingStack asChild>
      <SheetWithStackingRoot>
        <SheetWithStackingTrigger className="ExampleSheetWithStacking-trigger">
          Sheet with Stacking
        </SheetWithStackingTrigger>
