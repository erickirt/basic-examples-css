   ...
   return (
      ...
      >
         ...
         <SheetWithDetentPortal>
            <SheetWithDetentView>
               <SheetWithDetentBackdrop />
               <SheetWithDetentContent className="ExampleSheetWithDetent-content">
                  ...
                  <SheetWithDetentScrollRoot asChild>
                     <SheetWithDetentScrollView className="ExampleSheetWithDetent-scrollView">
                        <SheetWithDetentScrollContent className="ExampleSheetWithDetent-scrollContent">
